...
@section('title') Ubah Produk @endsection
        ...
        <div class="col-md-12 grid-margin">
            <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                    <h3 class="font-weight-bold">Ubah Produk</h3>
                            ...
                            <div class="tab-pane fade show active" id="product" role="tabpanel" aria-labelledby="product-tab">
                                <div class="form-group row">
                                    <div class="col">
                                        ...
                                        @if($product->picture)
                                            <div class="mb-3">
                                                <img src="{{ asset('storage/' . $product->picture) }}" alt="Foto Produk" style="max-width: 150px;">
                                            </div>
                                        @endif
                                ...
                                <div class="form-group row">
                                    <div class="col">
                                        ...
                                        <input class="typeahead @error('title') is-invalid @enderror" type="text" name="title" id="title" value="{{ old('title', $product->title) }}" placeholder="Masukan Nama Produk">
                                        @error('title')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-group row">
                                    <div class="col">
                                        ...
                                        <textarea class="typeahead" name="description" id="description" placeholder="Masukan Deskripsi Produk">{{ old('description', $product->description) }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col">
                                ...
                                <div class="form-group row">
                                    <div class="col">
                                        ...
                                        <input class="typeahead @error('default_price') is-invalid @enderror" type="number" name="default_price" id="default-price" value="{{ old('default_price', $product->default_price) }}" placeholder="Masukan Harga Produk" min="0" step="any">
                                        @error('default_price')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-group row">
                                    <div class="col">
                                        ...
                                        <select class="form-select @error('status') is-invalid @enderror" name="status" id="status">
                                            ...
                                            <option value="Sold" {{ old('status', $product->status) == 'Sold' ? 'selected' : '' }}>Habis</option>
                                        </select>
                                        @error('status')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                        ...
                                        @foreach($sales_types as $sales)
                                            <div class="form-group row">
                                                <div class="col">
                                                    ...
                                                    <input class="typeahead" type="number" name="prices[{{ $sales->id }}]" value="{{ old('prices[' . $sales->id . ']', $product->prices->where('sales_type_id', $sales->id)->first()->price ?? '') }}" placeholder="Masukan Harga {{ $sales->title }}">
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>
